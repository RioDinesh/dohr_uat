            ...
            GetConsOnlyVacancy(data, (err, Vacancy) => {
              ...
              fav.forEach((c1) => {
                Vacancy.forEach((c2) => {
                  ...
                  if (c1.ins_id == c2.created_by) {
                    ...
                    var list = c2.my_consultant!=null && c2.my_consultant!=""? JSON.parse(c2.my_consultant):[]; 
              ...
              for (i = 0; i < finalarray.length; i++) {
                if (Date(date) <= Date(finalarray[i].v_date)) {
                  if (arr.length != 0) {
                    var is_present = arr.find((x) => x.date === finalarray[i].v_date);
                  }
                  ...
                  if (is_present && arr.length != 0) {
                    ...
                    if (finalarray[i].assigned_to_external == null || finalarray[i].assigned_to_external == undefined || finalarray[i].assigned_to_external == "" || finalarray[i].assigned_to_external == 0 || finalarray[i].assigned_to_external == data.id) {
                      if (finalarray[i].vacancy_status == 0 || finalarray[i].vacancy_status == 1) {
                ...
                if (appo.length != 0) {
                  ...
                  appo.forEach((X) => {
                    arr.forEach((Y, i) => {
                      ...
                      if (Y.date == X.v_date && X.is_canceled==0&&X.vacancy_status!=0){

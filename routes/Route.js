...
Router.post("/add_legal", ADMIN_POST.add_Legal);
Router.post("/add_contactus_master", ADMIN_POST.add_Contactus_Master);
Router.post("/add_legal_description", ADMIN_POST.add_legal_description);
...
Router.post(
  ...
  ADMIN_POST.GetVacancyCancelUserDeatils
);
...
Router.post(
  "/Make_Consultant_InActive",
  ADMIN_EDIT.make_active_user_consultant
);
...
Router.post(
  "/Create_Uncovered_vacancy_external",
  INSTITUTE_POST.create_uncovered_vacancy_external
);
Router.post(
  "/Create_Uncovered_vacancy_internal",
  INSTITUTE_POST.create_uncovered_vacancy_internal
);
...
Router.post(
  "/Add_Completed_Feedback",
  COMMON_POST.add_feedback_to_completed_vacancy
);
...
Router.post(
  "/Get_My_Completed_Vacancy",
  COMMON_POST.get_my_completed_vacancy_api
);
...
Router.post(
  "/Get_vacancy_All_by_paid_status",
  COMMON_POST.Get_Vacancy_by_Paid_Status
);
...
Router.post(
  ...
  COMMON_POST.get_my_feedback_based_on_vacancy
);
//< POST//
...
Router.post(
  "/Get_Consultant_ScheduleCount",
  CONSULTANT_POST.Get_Consultant_Schedule_Count
);
...
//> EDIT//
Router.post(
  "/Update_ConsultantProfile",
  CONSULTANT_EDIT.Edit_Consultant_Profile
);
Router.post(
  "/Open_Application_Approve",
  CONSULTANT_EDIT.open_application_form_approve
);
Router.post(
  "/Ad_Application_Approve",
  CONSULTANT_EDIT.Ad_application_form_approve
);
//< EDIT//
...
Router.post(
  ...
  COMMON_DELETE.delete_inactive_consultant
);
...
Router.post("/inactive_customer", COMMON_DELETE.inactive_customer);
Router.post(
  "/delete_description_master",
  COMMON_DELETE.delete_description_ticktbox_master
);
Router.post("/delete_express_pass", COMMON_DELETE.delete_express_pass);
Router.post(
  "/delete_express_pass_users",
  COMMON_DELETE.delete_express_pass_users
);
...
Router.post(
  "/delete_feedback_for_dohr",
  COMMON_DELETE.delete_feedback_for_dohr
);
